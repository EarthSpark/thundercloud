...
from sparkmeter.tests.test_data_factory import (GroundFactory, MeterFactory, OperatorFactory,
                                                SMSConfigAlertFactory, SMSConfigCommandFactory,
                                                SMSMessageFactory, VendorFactory)
...
class EventTest(WebViewTestCaseBase):
    ...
    def test_format_message(self):
        ...
        with freeze_time("2010-01-01 12:01"):
            message = SMSMessageFactory(text='CMD', phone_number='+12345',
        ...
        with freeze_time("2010-01-01 12:03"):
            config_message = SMSConfigMessage.get_by_message_type(
                SMSConfigMessage.TYPE_VERIFY_NUMBER)
    ...
    def test_messages_json(self, client, config, operator_role, vendor_role):
        ...
        with freeze_time("2012-02-02 12:01"):
            SMSMessageFactory(phone_number=meter2.customer.phone_number,
                              direction=SMSMessage.DIRECTION_IN,
                              timestamp=datetime.datetime.utcnow(),
                              ground=other,
        ...
        with freeze_time("2012-02-03 12:01"):
            SMSMessageFactory(phone_number='+123',
                              direction=SMSMessage.DIRECTION_IN,
                              timestamp=datetime.datetime.utcnow(),
                              ground=None,
