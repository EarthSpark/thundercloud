...
__all__ = ["ReadMeterRegisterCommand"]

@dataclass
class ReadMeterRegisterCommand:
    """
    Read a single meter register (debug primitive).  Reply contract: **query reply**.
    Terminal event: `meter_register`.
    ...
    Args:
        ...
        correlation_id (str)     : Client-supplied id used to correlate every event the
                                   ...
                                   outstanding work.
        params (ReadMeterRegisterParams)
                                 : 
        vendor_options (ReadMeterRegisterCommandVendorOptions | None)
    ...
    params: ReadMeterRegisterParams
    vendor_options: ReadMeterRegisterCommandVendorOptions | None = None  # Vendor-specific extension data. The generic wire ignores this; the vendor's translator may consume it. See the vendor's capability documentation for accepted keys.
