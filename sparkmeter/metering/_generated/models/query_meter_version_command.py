...
__all__ = ["QueryMeterVersionCommand"]

@dataclass
class QueryMeterVersionCommand:
    """
    Read the firmware version reported by a meter.  Reply contract: **query reply**.
    Terminal event: `meter_version`.
    ...
    Args:
        ...
        correlation_id (str)     : Client-supplied id used to correlate every event the
                                   ...
                                   outstanding work.
        params (QueryMeterVersionParams)
                                 : 
        vendor_options (QueryMeterVersionCommandVendorOptions | None)
    ...
    params: QueryMeterVersionParams
    vendor_options: QueryMeterVersionCommandVendorOptions | None = None  # Vendor-specific extension data. The generic wire ignores this; the vendor's translator may consume it. See the vendor's capability documentation for accepted keys.
