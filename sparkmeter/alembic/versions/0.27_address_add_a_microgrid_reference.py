...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['microgrid_id'], ['microgrid.id'], ),
        sa.ForeignKeyConstraint(['address_id'], ['address.id'], ),
        sa.UniqueConstraint('microgrid_id', 'address_id',
                            name='microgrids_addresses_microgrid_address_unique'),
    ...
    op.drop_constraint(u'microgrid_address_id_fkey', 'microgrid', type_='foreignkey')
    ...
    op.create_foreign_key(u'address_microgrid_id_fkey',
                          'address', 'microgrid', ['microgrid_id'], ['id'])
...
def downgrade():  # pragma: nocoverage
    ...
    op.create_foreign_key(u'microgrid_address_id_fkey',
                          'microgrid', 'address', ['address_id'], ['id'])
    ...
    op.drop_constraint(u'address_microgrid_id_fkey', 'address', type_='foreignkey')
