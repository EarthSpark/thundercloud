...
def upgrade():
    ...
    # Create the column
    op.add_column(u'meter_models', sa.Column('phase_count', sa.INTEGER, nullable=False, server_default='1'))
    ...
    op.alter_column(u'meter_models', 'phase_count', server_default=None)
