...
def upgrade():
    ...
    op.drop_index('reading_needs_sync_true',
                  table_name='reading')
    op.drop_index('transaction_needs_sync_true',
                  table_name='transactions')

    op.drop_column(u'address', 'last_update')
    op.drop_column(u'address', 'needs_sync')
    op.drop_column(u'address', 'last_sync')
    op.drop_column(u'customer', 'last_update')
    op.drop_column(u'customer', 'needs_sync')
    op.drop_column(u'customer', 'last_sync')
    op.drop_column(u'dashboard_daily_tariff_summary', 'last_update')
    op.drop_column(u'dashboard_daily_tariff_summary', 'needs_sync')
    op.drop_column(u'dashboard_daily_tariff_summary', 'last_sync')
    op.drop_column(u'event', 'last_update')
    op.drop_column(u'event', 'needs_sync')
    op.drop_column(u'event', 'last_sync')
    op.drop_column(u'meter', 'last_update')
    op.drop_column(u'meter', 'needs_sync')
    op.drop_column(u'meter', 'last_sync')
    op.drop_column(u'meter_billing', 'last_update')
    op.drop_column(u'meter_billing', 'needs_sync')
    op.drop_column(u'meter_billing', 'last_sync')
    op.drop_column(u'meter_config', 'last_update')
    op.drop_column(u'meter_config', 'needs_sync')
    op.drop_column(u'meter_config', 'last_sync')
    op.drop_column(u'meter_system_info', 'last_update')
    op.drop_column(u'meter_system_info', 'needs_sync')
    op.drop_column(u'meter_system_info', 'last_sync')
    op.drop_column(u'meter_tag', 'last_sync')
    op.drop_column(u'meter_tag', 'needs_sync')
    op.drop_column(u'meter_tag', 'last_update')
    op.drop_column(u'meters_tags', 'last_sync')
    op.drop_column(u'meters_tags', 'needs_sync')
    op.drop_column(u'meters_tags', 'last_update')
    op.drop_column(u'microgrid', 'last_update')
    op.drop_column(u'microgrid', 'needs_sync')
    op.drop_column(u'microgrid', 'last_sync')
    op.drop_column(u'microgrids_addresses', 'last_sync')
    op.drop_column(u'microgrids_addresses', 'needs_sync')
    op.drop_column(u'microgrids_addresses', 'last_update')
    op.drop_column(u'reading', 'last_update')
    op.drop_column(u'reading', 'needs_sync')
    op.drop_column(u'reading', 'last_sync')
    op.drop_column(u'role', 'last_sync')
    op.drop_column(u'role', 'needs_sync')
    op.drop_column(u'role', 'last_update')
    op.drop_column(u'roles_users', 'last_update')
    op.drop_column(u'roles_users', 'needs_sync')
    op.drop_column(u'roles_users', 'last_sync')
    op.drop_column(u'sales_account', 'last_update')
    op.drop_column(u'sales_account', 'needs_sync')
    op.drop_column(u'sales_account', 'last_sync')
    op.drop_column(u'sales_accounts_users', 'last_sync')
    op.drop_column(u'sales_accounts_users', 'needs_sync')
    op.drop_column(u'sales_accounts_users', 'last_update')
    op.drop_column(u'sms_config', 'last_sync')
    op.drop_column(u'sms_config', 'needs_sync')
    op.drop_column(u'sms_config', 'last_update')
    op.drop_column(u'sms_message', 'last_sync')
    op.drop_column(u'sms_message', 'needs_sync')
    op.drop_column(u'sms_message', 'last_update')
    op.drop_column(u'sparkmac_node', 'last_update')
    op.drop_column(u'sparkmac_node', 'needs_sync')
    op.drop_column(u'sparkmac_node', 'last_sync')
    op.drop_column(u'tariff', 'last_update')
    op.drop_column(u'tariff', 'needs_sync')
    op.drop_column(u'tariff', 'last_sync')
    op.drop_column(u'transaction_sources', 'last_sync')
    op.drop_column(u'transaction_sources', 'needs_sync')
    op.drop_column(u'transaction_sources', 'last_update')
    op.drop_column(u'transactions', 'last_sync')
    op.drop_column(u'transactions', 'needs_sync')
    op.drop_column(u'transactions', 'last_update')
    op.drop_column(u'user', 'last_sync')
    op.drop_column(u'user', 'needs_sync')
    op.drop_column(u'user', 'last_update')
    op.drop_column(u'wallet', 'last_sync')
    op.drop_column(u'wallet', 'needs_sync')
    op.drop_column(u'wallet', 'last_update')
