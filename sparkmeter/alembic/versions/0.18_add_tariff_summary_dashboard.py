...
def upgrade():
    ...
    op.create_index(
        ...
        'dashboard_daily_tariff_summary', ['needs_sync'], unique=False,
        postgresql_where=sa.text(u'needs_sync = TRUE'))
    ...
    op.create_unique_constraint('meter_heartbeat_start_unique', 'reading',
                                ['meter', 'heartbeat_start'])
...
def downgrade():  # pragma: nocoverage
    ...
    op.drop_index('dashboard_daily_tariff_summary_needs_sync_true',
                  table_name='dashboard_daily_tariff_summary')
