...
def upgrade():
    ...
    op.drop_constraint(u'meter_customer_id_fkey', 'meter', type_='foreignkey')
    op.drop_column('meter', 'customer_id')


def downgrade():  # pragma: nocoverage
    """Downgrade the database schema from 0.20 to 0.19."""
    op.add_column('meter', sa.Column('customer_id', postgresql.UUID(),
    ...
    op.create_foreign_key(u'meter_customer_id_fkey', 'meter', 'customer', ['customer_id'], ['id'])
