...
def upgrade():
    ...
    op.add_column('sms_message', sa.Column('config_alert_id', UUIDType(binary=True),
                                           sa.ForeignKey('sms_config_alert.id'), nullable=True))
    op.add_column('sms_message', sa.Column('config_command_id', UUIDType(binary=True),
                                           sa.ForeignKey('sms_config_command.id'), nullable=True))
    op.add_column('sms_message', sa.Column('config_message_id', UUIDType(binary=True),
                                           sa.ForeignKey('sms_config_message.id'), nullable=True))
