...
class GroundViewTest(WebViewTestCaseBase):
    ...
    def test_edit_max_capacity(self, client):
        ...
        response = client.post(path, data={"serial": ground.serial, "max_capacity": "10"})
    ...
    def test_edit_max_capacity_max_int(self, client):
        ...
        response = client.post(path, data={"serial": ground.serial, "max_capacity": MAX_SIGNED_INT})
        self.verify_response(response, variant="active")
    ...
    def test_edit_max_capacity_over_max_int(self, client):
        ...
        response = client.post(path, data={"serial": ground.serial, "max_capacity": (MAX_SIGNED_INT + 1)})
        self.verify_response(response)
    ...
    def test_edit_max_capacity_blank(self, client):
        ...
        response = client.post(path, data={"serial": ground.serial, "max_capacity": ""})
        self.verify_response(response)
