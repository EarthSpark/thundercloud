...
@click.option(
    "--watch-assets/--no-watch-assets", default=False, help="Enable asset watching (CSS/JS compilation)."
)
@click.option("--demo-login/--no-demo-login", default=True, help="Enable or disable demo login (dev only).")
@with_appcontext
def dev(host, port, debug, reload, watch_assets, demo_login):
    ...
    def start_watchers():
        ...
        pids.append(p.pid)
        wait_for_assets("javascripts/application.js", "javascripts/vendor.js", "stylesheets/application.css")
